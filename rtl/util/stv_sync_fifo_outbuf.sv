...
// current count. The memory is not reset. SKID=1 cuts ready coupling when full,
// so a full FIFO cannot accept a push in the same cycle as a pop. This outbuf
// module forces the output to come from a single buffer, which should improve
// downstream timing. Inputs always take at least one cycle to appear on the
// output.
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
  ...
  logic [WIDTH-1:0] buffer_din;
  logic  buffer_dout_valid;
  logic  buffer_dout_ready;
  logic [WIDTH-1:0] buffer_dout;
