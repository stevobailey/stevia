...
//
// This is the pre-modernization optimized tree implementation retained for
// future restoration. The active library currently uses rtl/util/stv_lzc.sv,
// which is simpler and accepted by the stock Yosys SystemVerilog frontend used
// in CI. This version preserves the original tree structure so it can be
// adapted later without rediscovering the design.
//
